...
// const - can't reassign the value
...
let endTime   /// implicit any value because you haven't stated a type here
//but we can give a type annotation
// let endTime: 0
setTimeout(() => {
    //endTime = 0
    endTime = new Date()
...
// but then endTime =0 won't work hence me commenting out 
...
//eslint and ts work super well together.
